...
public class AssociationRulesXmlParser {
	...
	/**
	 * Statick� funkce pro rozd�len� XML �et�zce AssociationRules na jednotliv� ��sti, kter� je pot� mo�n� transformovat
	 * @param xmlString
	 * @return
	 */
	...
	/**
	 * Statick� funkce pro vytvo�en� transformeru pro XML transformace
	 * @return
	...
	/**
	 * Statick� funkce pro XSL transformaci velk�ho XML
	 * @param xmlString
	 * @param xslTemlate
	 * @return
	 * @throws TransformerFactoryConfigurationError
